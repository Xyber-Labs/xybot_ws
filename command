...
#patrol_app
ros2 launch app patrol_node.launch.py debug:=true
ros2 service call /patrol_app/enter std_srvs/srv/Trigger {}
ros2 service call /patrol_app/set_running interfaces/srv/SetInt64 "{data: 1}"
...
#arm_pc
python3 ~/software/arm_pc/main.py
